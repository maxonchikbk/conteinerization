...
if [[ "$(ver $DOCKER_VERSION)" -lt "$(ver $MIN_DOCKER_VERSION)" ]]; then
  confirm "Minimum Docker version to be $MIN_DOCKER_VERSION. Found $DOCKER_VERSION. Do you wish to proceed?"  
fi

# if [[ "$(ver $COMPOSE_VERSION)" -lt "$(ver $MIN_COMPOSE_VERSION)" ]]; then
#   confirm "Minimum docker-compose version to be $MIN_COMPOSE_VERSION. Found $COMPOSE_VERSION. Do you wish to proceed?"  
# fi
